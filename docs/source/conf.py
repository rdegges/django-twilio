# -*- coding: utf-8 -*-
#
# django-twilio documentation build configuration file, created by
# sphinx-quickstart on Wed Sep  7 18:43:55 2011.
#
...
sys.path.insert(0, os.path.abspath('../../django_twilio'))
